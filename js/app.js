//set of gems on the screen, including hearts and stars
var Gems = function(){
...
var Popup = function(){
    this.options = ["PRESS [SPACE] TO START", "", "YOU DIED"];
    this.content = "";
    this.state = 0;
};

//Putting gems at random at the start of each level
...
// Parameter: mv, a time delta between ticks
Enemy.prototype.update = function(mv) {
    // multiply movement by mv to ensure the game runs at the same speed for all computers   
...
//Player movement using a switch
...
Player.prototype.update = function(mv){
...
Popup.prototype.render = function(){
    if (gameState != 1){
        ...
        ctx.strokeStyle = "red";
        ctx.lineWidth = 3;
        ctx.strokeRect(52,252, 510, 635);
        ctx.fillRect(0,0, 510, 635);
        ctx.fillStyle = "red";
